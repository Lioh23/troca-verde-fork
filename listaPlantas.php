    ...
    <form action="" class="row mb-5">
      <div class="col-12 mx-auto">
        <div class="input-group mb-4 rounded-pill p-1 input-custom-avocado" style="overflow: hidden;">
          <input type="search" name="especie" placeholder="Busque uma planta" value="<?= $_GET['especie'] ?? '' ?>"
              aria-describedby="button-addon3" class="form-control shadow-none bg-none border-0">
      ...
      <div class="col-12">
        ...
        <?php if($plantasDisponiveis['total'] > 0): ?>
          ...
          <div class="d-flex justify-content-between">
              ...
              <a href="<?= $plantasDisponiveis['prev'] ?>" 
                  class="btn btn-primary rounded-pill <?= !$plantasDisponiveis['prev'] ? 'disabled' : '' ?>"
                  style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;">
                Anterior
              </a>
              <a href="<?= $plantasDisponiveis['next'] ?>" 
                  class="btn btn-primary rounded-pill <?= !$plantasDisponiveis['next'] ? 'disabled' : '' ?>"
                  style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;">
                Próxima
              </a>
